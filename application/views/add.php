...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <?php
      echo $this->session->flashdata('cadastro-erro');
      ?>
    </div>
  </div>
          ...
          <div class="panel-body">
            <form action="salvar" class="form-horizontal" method="post" id="form">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" name="id" id="id" value=1 required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" name="dateOpen" id="dateOpen" required>
                </div>
              </div>
              <div class="form-group">
...
<script>
  var dateOpen, dateClose, form;

  form = document.getElementById("form");
  dateOpen = document.getElementById("dateOpen").value;
  dateClose = document.getElementById("dateClose").value;

  dopen = new Date(dateOpen.value);
  dclose = new Date(dateClose.value);

  form.addEventListener('submit', function(e) {
    //if (dateClose.value == null) {
    // if (dateClose.value < dateOpen.value) {
    //alert("A data de fechamento deve ser após a de abertura");
    //alert("do:" + dopen.getTime().value);
    //alert("dc:" + dclose.getTime().value);
    //  alert("Cadastrar a ordem de serviço")
    //}
    //}
